...
const ContactMe = () => {
    ...
    return (
      <section className="relative mt-96 bg-[#272727] text-white">
        <div className="grid grid-cols-2 h-full">
          <div className="p-8">
            ...
            <div className="bg-[#363636] h-[450px] mt-2 rounded-xl p-8">
              ...
              <h4 className="font-medium mb-3 text-[20px]">
                Lets Get Started!
              </h4>
              <p className="mb-4">
              ...
              <form action="">
                <input className="px-4 py-2 w-full rounded-lg mb-2 bg-slate-100" type="text" placeholder="Full Name"/>
                <input className="px-4 py-2 w-full rounded-lg mb-2 bg-slate-100" type="email" placeholder="Email"/>
                <input className="px-4 py-2 w-full rounded-lg mb-4 bg-slate-100" type="text" placeholder="How Can We Help You?"/>
